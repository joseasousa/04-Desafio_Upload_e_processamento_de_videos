...
Step 2 splits into **2a** (capture description in plain language) and **2b** (Codex proposes a derived name + IC prefix; user accepts or overrides). The user never types kebab-case unless they want to override.
