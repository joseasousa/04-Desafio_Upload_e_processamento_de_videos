...
export const envValidationSchema = Joi.object({
  ...
  STORAGE_SECRET_KEY: Joi.string().default('streamtube'),
  STORAGE_BUCKET: Joi.string().default('streamtube-videos'),
  STORAGE_PRESIGNED_EXPIRES_SECONDS: Joi.number().default(900),
  QUEUE_HOST: Joi.string().default('redis'),
  QUEUE_PORT: Joi.number().default(6379),
  VIDEO_MAX_SIZE_BYTES: Joi.number().default(10 * 1024 * 1024 * 1024),
